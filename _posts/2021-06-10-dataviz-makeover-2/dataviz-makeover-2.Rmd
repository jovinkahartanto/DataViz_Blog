...
## 2.1 Clarity
1. The label is not very informative, for example, it can state number of import, export, and total
2. There is no gridlines in the chart to help the audience compare the import and export values 
3. There is not enough annotation or tooltip that can show the audience the import and export value
4. There is no explanation of what is the label in each bubble represent, it can caused misinterpretation
5. There is no clear explanation on how to determine the top net exporter and top net importer
...
# Clarity:
1. 
2. Added more information for each plot, which are total import, total export, total import and export, and lastly monthly trend for the selected year
